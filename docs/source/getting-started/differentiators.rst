...
.. raw:: html
    ...
    <div class="cell large-4 small-4">
      ...
      <dotlottie-wc src="https://developers.scylladb.com/stable/_static/img/shard-per-core-no-bg.lottie" speed="1" style="width: 400px; height: 400px; margin-top: -100px" mode="forward" loop autoplay></dotlottie-wc>
